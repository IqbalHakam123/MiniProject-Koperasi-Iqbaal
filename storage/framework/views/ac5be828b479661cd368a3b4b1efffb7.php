...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('barangs.store')); ?>" method="POST" class="needs-validation" novalidate="">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="kodeBarang" id="kodeBarang" value="<?php echo e(old('kodeBarang')); ?>" placeholder="Masukan kode barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="hargaBarang" id="hargaBarang" value="<?php echo e(old('hargaBarang')); ?>" placeholder="Harga barang">
...
unset($__errorArgs, $__bag); ?>" name="deskripsi" id="deskripsi" value="<?php echo e(old('deskripsi')); ?>" placeholder="Deskripsi">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Iqbal hakam hafidz\OneDrive\Desktop\Percobaan3\resources\views/barang/create.blade.php ENDPATH**/ ?>